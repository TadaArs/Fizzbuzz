...
func TestFizzBuzz(t *testing.T) {
	...
	t.Run("should return string of 11 when input 11", func(t *testing.T) {
		input := 11
		want := "11"
	...
	t.Run("should return string of 13 when input 13", func(t *testing.T) {
		input := 13
		want := "13"
	...
	t.Run("should return string of 14 when input 14", func(t *testing.T) {
		input := 14
		want := "14"
